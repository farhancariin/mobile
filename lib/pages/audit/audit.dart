...
class AuditScreen extends StatefulWidget {
  ...
  final String title = "Rapat Tinjauan Manajement";

  @override
  AuditScreenState createState() => AuditScreenState();
}

class AuditScreenState extends State<AuditScreen> {
          ...
          if (snapshot.hasData) {
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var now = DateTime.parse(item["rtm_time"]);
                  return Card(
                    child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                Text(item["topic"] + "\n Karyawan: ${item['employee_name']} \n Pendamping: ${item['employee_partner']}",overflow: TextOverflow.clip,)
